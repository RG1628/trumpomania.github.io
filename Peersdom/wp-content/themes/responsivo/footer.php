...
?>
	...
	<div id="footercontainer">
		...
		<div class="social-media-icons">
			<?php echo responsivo_get_social_media(); ?>
		</div>

		<?php if ( of_get_option( 'footer_content', responsivo_get_credits() ) ) {
			echo '<div class="row smallprint">';
			echo apply_filters( 'meta_content', wp_kses_post( of_get_option( 'footer_content', responsivo_get_credits() ) ) );
			echo '<p>'.__( 'Theme designed by', 'responsivo' ).' <a rel="nofollow" href="http://www.webempresa.com/" target="_blank">Webempresa</a></p></div> <!-- /.smallprint -->';
		} ?>
