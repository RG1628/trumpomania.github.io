<?php
	...
	if( !class_exists( 'gardener_widget_post_tags' ) ){

		class gardener_widget_post_tags extends WP_Widget
		{
			/**
             *  Widget Constructor
             */
		    ...
		    {
		        parent::__construct( 'gardener_widget_post_tags', __( 'Post Tags', 'gardener' ) . ' [' . tempo_core::theme( 'Name' ) . ']', array(
		            'classname'     => 'tempo_widget_post_tags',
		            'description'   => __( 'This widget can be used only for single.php template', 'gardener' )
		        ));
		    }
