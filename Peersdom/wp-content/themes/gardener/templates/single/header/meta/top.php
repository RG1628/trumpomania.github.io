<?php
    ...
    $show_author    = apply_filters( 'gardener_meta_post_author',     tempo_options::get( 'post-author' ) );
    $show_time      = apply_filters( 'gardener_meta_post_time',       tempo_options::get( 'post-time' ) );
