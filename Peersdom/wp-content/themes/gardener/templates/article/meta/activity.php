<?php
    ...
    $show_comments  = apply_filters( 'gardener_blog_comments',   tempo_options::get( 'blog-comments' ) );
    $show_views     = apply_filters( 'gardener_blog_views',      tempo_options::get( 'blog-views' ) );
    ...
    echo '<div class="tempo-meta-activity article">';
